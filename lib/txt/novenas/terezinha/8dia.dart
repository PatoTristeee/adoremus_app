...
class VIIIDia extends StatelessWidget {
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          children: [
            Text(
              "8º Dia - Pelos prisioneiros.\n"
              "Santa Terezinha próxima dos prisioneiros.",
              style: TextStyle(
            ...
            Text(
              'Neste dia rezemos por todos os encarcerados e pelos que se encontram presos em si mesmo, pelo pecado.',
              style: TextStyle(
