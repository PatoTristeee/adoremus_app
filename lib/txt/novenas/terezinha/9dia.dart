...
class IXDia extends StatelessWidget {
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          children: [
            Text(
              "9º Dia - Pelos incrédulos.\n"
              "Santa Terezinha solidária aos incrédulos.",
              style: TextStyle(
            ...
            Text(
              'Neste último dia da Novena de Santa Terezinha, rezemos pelos que não creem, não esperam e não confiam em Deus.',
              style: TextStyle(
