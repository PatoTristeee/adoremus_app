...
class IDia extends StatelessWidget {
  final double fontTitleSize;
  final double fontTextSize;

  const IDia({super.key, required this.fontTitleSize, required this.fontTextSize});
  @override
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Text(
              "1º Dia - Pelo Clero.\n"
              "Santa Terezinha, Doutora e amante da igreja.",
              style: TextStyle(
